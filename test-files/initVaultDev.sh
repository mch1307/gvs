...
./vault write auth/approle/role/my-role policies=VaultDevAdmin secret_id_ttl=100m token_num_uses=100 token_ttl=5s token_max_ttl=300m secret_id_num_uses=40 >> /tmp/vaultdev.log
